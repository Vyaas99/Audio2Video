...
from models.unet_3d_blocks import ( # this is a file in the same directory as this one
    ...
    def __init__(
        ...
        for i, down_block_type in enumerate(down_block_types):
            ...
            down_block = get_down_block(
                ...
                num_attention_heads=attention_head_dim[i], # they renamed it from attn_num_head_channels
