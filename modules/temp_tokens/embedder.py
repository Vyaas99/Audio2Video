...
class TempEmbedder(nn.Module):
    def __init__(self, input_size=512, hidden_size=2304, output_size=1024, class_token=True, seq_target_length=24):
        ...
        self.fc3 = nn.Linear(hidden_size, 1024*3)
    ...
    def forward(self, audio_embs):
        ...
        audio_embs = self.gelu(audio_embs)
        audio_embs = self.fc3(audio_embs) # [1, 96, 1024]
